...
public class SliderActivity extends AppCompatActivity {
    ...
    private SliderActivity.MyViewPagerAdapter myViewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // layout xml 1-4
        // add view more layouts if you want
        layouts =new int[]{
                R.layout.slide1,
                R.layout.slide2,
                R.layout.slide3,
        ...
        myViewPagerAdapter = new SliderActivity.MyViewPagerAdapter();
    ...
    private void launchHomeScreen() {
        ...
        startActivity(new Intent(SliderActivity.this, OpsiActivity.class));
        finish();
    }
